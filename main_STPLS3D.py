...
from tool import ConfigSTPLS3D as cfg
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_area', type=str, default="WMSC_points", help='Which area to use for test, option: 1-6 [default: 5]')
    ...
    dataset = STPLS3D(test_area, FLAGS.labeled_point, FLAGS.retrain)
